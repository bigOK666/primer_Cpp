...
public:
	...
	TextQuery() = default;
	//一定要分配自由内存给智能指针
	TextQuery(ifstream& infile) :input_data(new vector<string>, DebugDelete()), query_data(new map<string, set<size_t>>, DebugDelete()) { store(infile); }
...
int main(int argc, char** argv)
{
	...
	std::cout << "runQueries is finished calling" << std::endl;
